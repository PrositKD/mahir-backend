...
const postCaseCategoryValidationSchema = z.object({
    body: z.object({
        name: z.record(
            languageEnum,
            z
...
const updateCaseCategoryValidationSchema = z.object({
    body: z.object({
        _id: z
            .string({
...
export const CaseCategoryValidations = {
    postCaseCategoryValidationSchema,
    updateCaseCategoryValidationSchema,
};
